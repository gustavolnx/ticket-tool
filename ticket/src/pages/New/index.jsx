    ...
    export default function New(){
                ...
                if (snapshot.docs.size === 0)
                    {
                        ...
                        setCustomers([{id:1, nomeFantasia: 'Nenhum cliente encontrado'}])
                        return;
                    }
        ...
        return(
            ...
            <div className='content'>
                <Title name ={id? "Editando chamado" : "Novo chamado"}> <FiPlusCircle size={25}/>
                </Title> 
                <div className="container">
                    ...
                    <form className="form-profile" onSubmit={handleRegister}>
                        ...
                        <div className="status">
                            <input type="radio" name="radio" value="Aberto" className='radio' onChange={handleOptionChange} checked={status==='Aberto'}/> 
                            <span>Em aberto</span>
                            <input type="radio" name="radio" value="Progresso" className='radio' onChange={handleOptionChange} checked={status==='Progresso'}/> 
